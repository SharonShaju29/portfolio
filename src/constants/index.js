const constants = {
  socialLinks: {
    facebook: "https://www.facebook.com/sharon.shaju.549/",
    instagram: "https://www.instagram.com/sharonfreakzz/",
    git: "https://github.com/SharonShaju29",
    linkedIn: "https://www.linkedin.com/in/sharon-shaju-a26243219/",
  },
  contactDetails: {
    phone: {
      type: "Phone",
    ...
    email: {
      type: "Email",
      info: "sharonshaju2901@gmail.com",
    },
    location: {
      type: "Location",
      info: "Ooty, The Nilgiris",
    },
  },
  tabs: [{ name: "Home" }, { name: "Work" }, { name: "Skills" }],
  skillsDesc: [
    {
    ...
    },
    {
      ...
      content:
        "I am very much interested to reasearch on the latest technologies and get the pulp of the matter by diving deep into it. ",
    },
  ],
  internDescription:
